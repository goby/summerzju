...
namespace NewSummerProject
{
    public sealed partial class MainForm : Form
    {
        ...
        private void ClientDisplay(bool show)
        {
            if (!show)
            {
                axMapControl1.Visible = false;
                axTOCControl1.Visible = false;
        ...
        private void 连接数据库CToolStripMenuItem_Click(object sender, EventArgs e)
        {
            MyForms.DbConnForm connForm = new NewSummerProject.MyForms.DbConnForm();
            connForm.ShowDialog();
        }

        private void 生成RasterRToolStripMenuItem_Click(object sender, EventArgs e)
        {
